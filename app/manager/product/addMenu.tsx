...
import { PlusCircle, X, Save, Upload, BikeIcon as Motorcycle } from "lucide-react"
...
const AddMenu = ({ size = "default" }: AddMenuProps) => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    try {
      e.preventDefault()
      setIsLoading(true)
      const url = `${BASE_API_URL}/M/createM`
  ...
  return (
    <>
      <button
        ...
        `}
      >
        <PlusCircle className={size === "lg" ? "h-6 w-6" : "h-5 w-5"} />
        ...
        <DialogContent className="sm:max-w-[800px] p-0 overflow-hidden">
          <DialogHeader className="px-6 pt-6 pb-4 border-b border-gray-100">
            <div className="flex items-center">
              <Motorcycle className="h-6 w-6 text-blue-600 mr-3" />
              <div>
                <DialogTitle className="text-xl font-bold text-gray-900">Add New Motorcycle</DialogTitle>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="text-blue-900 w-full rounded-lg border border-gray-300 p-3 text-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition-all"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        id="price"
                        type="number"
                        value={menu.price === 0 ? "" : menu.price} // Perubahan di sini
                        onChange={(e) => {
                          const value = e.target.value
                          setMenu({ ...menu, price: value === "" ? 0 : Number(value) }) // Fixed type issue
                        }}
                        required
                        min="0"
                        className=" text-blue-900 w-full rounded-lg border border-gray-300 p-3 pl-9 text-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition-all"
                  ...
                  <div>
                    ...
                    <div className="flex gap-4 mt-2">
                      <label className="flex items-center">
                        ...
                        />
                        <span className="text-sm text-blue-900 ">Yes</span>
                      </label>
                      <label className="flex items-center">
                        <input
                          type="radio"
                          ...
                          className="mr-2 h-4 w-4 text-blue-600 focus:ring-blue-500"
                        />
                        <span className="text-sm text-blue-900 ">No</span>
                      </label>
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div
                    ...
                    `}
                    onClick={() => document.getElementById("motorcycle_picture")?.click()}
                  >
                    {previewUrl ? (
