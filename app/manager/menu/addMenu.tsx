        ...
        <div>
            ...
            <Modal isShow={isShow} onClose={state => setIsShow(state)}>
               <form onSubmit={handleSubmit}>
                   ...
                   {/* modal body */}
                   <div className="p-5">
                       <InputGroupComponent className="text-black" id={`name`} type="text" value={menu.name}
                           onChange={val => setMenu({ ...menu, name: val })}
                           required={true} label="Name" />


                       <InputGroupComponent className="text-black" id={`price`} type="number" value={menu.price.toString()}
                           onChange={val => setMenu({ ...menu, price: Number(val) })}
                           required={true} label="Price" />


                       <InputGroupComponent className="text-black" id={`description`} type="text" value={menu.description}
