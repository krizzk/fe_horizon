...
const LoginPage = () => {
    ...
    // Simpan referensi audio di luar fungsi
    const audio = new Audio('/audio/forgetPassword.mp3'); // Pastikan path ini benar
    ...
    return (
        <div className="w-screen h-screen bg-login bg-cover">
            ...
            <div className="w-full h-full bg-backdrop-login flex justify-center items-center p-5">
                <div className="backdrop-blur-lg w-full md:w-6/12 lg:w-4/12 min-h-[600px] border rounded-xl bg- p-5 flex flex-col items-center relative">
                    <div className="absolute bottom-0 left-0 w-full py-2 text-center">
                        <small className="text-white">Copyrihgt @2024</small>
                    </div>
                    <Image alt="moklet-app" width={150} height={100} src={`/image/restaurant.jpg`}
                    ...
                    <form onSubmit={handleSubmit} className="w-full my-10">
                        <div className="flex w-full my-4">
                            <div className="bg-white rounded-l-md p-3">
                            ...
                            <input type="text" className="border p-2 grow rounded-r-md focus:outline-none focus:ring-primary focus:border-primary text-black" value={email}
                        ...
                        <div className="flex w-full my-4">
                            ...
                            className="border p-2 grow focus:outline-none focus:ring-primary focus:border-primary text-black" 
                            value={password}
                            onChange={e => setPassword(e.target.value)} 
                            placeholder="Password" id={`password-industri-app`} />
                            
                            <div className="cursor-pointer bg-white rounded-r-md p-3" onClick={() => setShowPassword(!showPassword)}>
                                {
                                    showPassword ?
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="black" className="size-4">
                        ...
                        <div className="relative my-10">
                            <button type="submit" className="bg-yellow-500 hover:bg-primary uppercase w-full p-2 rounded-md text-white">
                                Login
                            </button>
                            <button type="button" onClick={playAudio} className="absolute right-0 text-white mt-[-40px] hover:underline  ">
                                Forget Password?
                            </button>
                        </div>
                    </form>
