      ...
      <div className="relative bg-gradient-to-r from-blue-900 via-blue-800 to-blue-700 rounded-2xl overflow-hidden mb-8 shadow-xl">
        ...
        <div className="relative z-10 px-8 py-12 flex flex-col md:flex-row items-center justify-between">
          <div className="mb-6 md:mb-0">
            ...
            Your one-stop destination for the latest and greatest motorcycles. Explore our collection and find your perfect ride.
            </p>
      ...
      <div className="bg-white rounded-xl p-6 shadow-md mb-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="w-full md:w-1/2 lg:w-1/3">
            <form action="/user/product" method="GET">
              ...
              <div className="relative w-full">
                ...
                {search && (
                  <Link
                    href={`/user/product${classFilter !== "all" ? `?class=${classFilter}` : ""}${sort !== "newest" ? `${classFilter !== "all" ? "&" : "?"}sort=${sort}` : ""}`}
          ...
          <div className="flex items-center gap-3">
            <form action="/user/product" method="GET" className="flex items-center gap-3">
      ...
      {menu.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 stagger-animation">
          {menu.map((data, index) => (
            ...
            >
              <Link href={`/user/detail/${data.id}`} className="block">
